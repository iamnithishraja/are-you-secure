    ...
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            <p><strong>Site:</strong> {BreachesSummary.site}</p>
            <p><strong>Domain:</strong> {breach.domain}</p>
            <p><strong>Industry:</strong> {breach.industry}</p>
            <p><strong>Exposed Date:</strong> {breach.xposed_date}</p>
            <p><strong>Exposed Records:</strong> {breach.xposed_records.toLocaleString()}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center mb-2">
              <div className={`w-16 h-16 rounded-full ${getRiskColor(riskScore)} flex items-center justify-center text-white font-bold text-xl mr-4`}>
                {riskScore}
              </div>
              <div>
            ...
            <Alert>
              ...
              <AlertDescription>
                {Object.entries(BreachMetrics.passwords_strength[0]).map(([key, value]) => (
